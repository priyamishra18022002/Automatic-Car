...
function save(){
    if (confirm("This will update the car's brain. Are you sure you want to do that?") == true) {
...
function discard(){
    if (confirm("This will remove the car's brain and you'll need to train the system again. Are you sure you want to do that?") == true) {
